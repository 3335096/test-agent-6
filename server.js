...
6) Для EDITOR учитывай настройку post_mode и соблюдай длину:
   - short: итоговый текст до 700 символов включительно.
   - long: итоговый текст в диапазоне 1200–2200 символов.
   Если пользователь явно просит другой объём, приоритет у запроса пользователя.
