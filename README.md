...
|-------|---------------------|
| **Content Creator** | Посты, сценарии, рубрики |
| **Editor** | Вычитка, редактура |
| **Analyst** | Исследования, метрики, тренды |
| **Designer** | Визуалы, инфографика |
| **SMM Manager** | Планирование, модерация |
| **Growth Manager** | Стратегия роста, лидогенерация |
